      ...
      <div className="max-w-xl w-full">
        ...
        <div className="bg-card border border-border p-8 rounded-xl min-h-[400px] flex flex-col">
              ...
              >
                ...
                <div className="space-y-6 py-4">
                  <div className="flex items-center justify-center gap-8 relative">
                    ...
                    <div className="flex-1 h-px bg-dashed bg-gradient-to-r from-accent to-primary" />
                  ...
                  {loading ? (
                    ...
                    <div className="space-y-3">
                       <Button variant="outline" className="w-full h-14 justify-start gap-4 px-4 border-border hover:border-primary/50 transition-all">
                  ...
                  <p className="text-[11px] text-muted-foreground text-center italic">
                    Note: This binding is permanent for your current identity.
                  </p>
                </div>
              </motion.div>
            )}
          ...
          <div className="mt-auto flex items-center justify-between pt-8">
            ...
            <Button 
              onClick={handleNext} 
              disabled={loading || (currentStep === 1 && !matric) || (currentStep === 4 && !role)}
              className="bg-primary text-white hover:bg-primary/90 px-8"
            >
              {loading ? <Loader2 className="w-4 h-4 animate-spin mr-2" /> : null}
              {currentStep === 4 ? "Complete" : "Continue"} <ChevronRight className="ml-2 w-4 h-4" />
            </Button>
          </div>
        </div>
      </div>
